...
docker run -t -v /home/stransky/skripty/xdskappa:/src/xdskappa --user=$UID fedora:pyinst2 /bin/bash -c "cd /src/xdskappa; ./compile-fedora.sh"
docker run -t -v /home/stransky/skripty/xdskappa:/src/xdskappa --user=$UID centos:pyinst2 /bin/bash -c "cd /src/xdskappa; ./compile-centos7.sh"

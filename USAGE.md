...
In _Proteum_, tab _Reduce data_, _Convert images_. Select datasets to convert and path where to put CBF files. Choose ''cbf'' from drop down menu and uncheck ''unwrap''.
